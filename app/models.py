...
class pr_users(db.Model):
    ...
    def __repr__(self):
        return 'id{}' \
               ...
               'tel_chat_id{}' \
               'created{}' \
               'modified{}>'.format(self.prus_id, self.prus_name, self.prus_email, self.prus_password_hash,
                                    self.prus_phone, self.prus_role_id, self.prus_tel_chat_id,
                                    self.prus_date_created, self.prus_date_modified)
...
class pr_roles(db.Model):
    ...
    def __repr__(self):
        return '<prro_role_name {}>'.format(self.prro_role_name)
...
class pr_orders(db.Model):
    ...
    def __repr__(self):
        return '<pror_comment {}>'.format(self.pror_comment)
